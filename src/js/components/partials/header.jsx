    ...
    return (
      <nav className='navbar navbar-expand-sm bg-dark navbar-dark ttt-custom-header' id='header-7319'>
        ...
        <ul className='navbar-nav'>
          <li className='nav-item home active'><Link to='/about'>{language.home}</Link></li>
          ...
          <li className='nav-item portfolio'><a target='_blank' href='https://cv.tttgalaxy.co.uk'>{language.portfolioPage}</a></li>
          <li className='nav-item shopping'><a target='_blank' href='https://shop.tttgalaxy.co.uk'>{language.shop}</a></li>
